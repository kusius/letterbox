...
object MimeTypes {
    fun String.asMimeType(): MimeType =
        if (Application.fromMimeType(this) != null) {
            Application.fromMimeType(this)!!
        } else if (Text.fromMimeType(this) != null) {
            Text.fromMimeType(this)!!
        } else if (Multipart.fromMimeType(this) != null) {
            Multipart.fromMimeType(this)!!
        } else if (Image.fromMimeType(this) != null) {
            Image.fromMimeType(this)!!
        } else {
            throw IllegalStateException("Unknown mime type $this")
        }
    ...
    enum class Multipart(
        ...
        companion object {
            fun fromMimeType(mime: String) = entries.find { it.mimeType == mime }
        }
    }
